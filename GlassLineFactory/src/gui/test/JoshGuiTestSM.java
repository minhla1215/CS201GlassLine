...
public class JoshGuiTestSM implements TReceiver
{
	Transducer t;
	FactoryPanel f;

	boolean offlineDone = false;
	boolean randomGUIIsRunning = true;

	public JoshGuiTestSM(Transducer t, FactoryPanel f)
	{
		this.f = f;
		this.t = t;
		...
		t.register(this, TChannel.CORNER);
